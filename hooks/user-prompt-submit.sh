...
If any Codex or Gemini MCP call fails with timeout, tool-unavailable, session-failed, session/tool instability, model error, or permission-blocked, output BLOCKED. Do not retry or switch executors.
