...
- If MCP returns `command line is too long`, treat it as prompt-packaging failure: output `BLOCKED`, do not retry/switch, and convert long input to file-backed artifacts.
