...
1. Inspect current project state first: relevant files, docs, recent commits, and CP0 context-retrieval via mandatory `codebase-retrieval` before CP1 whenever implementation routing is involved.
...
- `skills/shared/supplementary-tools.md` — mandatory CP0 `codebase-retrieval` fail-closed rule and Grok Search external/current-only guidance.
